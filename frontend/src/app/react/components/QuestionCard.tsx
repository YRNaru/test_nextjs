...
export default function QuestionCard({
  ...
  return (
    <div
      ...
      data-oid="km1opl_"
    >
      <h3 className="mb-5 text-[var(--card-text)] text-2xl" data-oid="j6ndc3t">
        {question.question}
      </h3>
      {question.code && (
        <pre
          ...
          data-oid="dhefccu"
        >
          <code className="text-[var(--card-text)]" data-oid="-2rk1:.">
            {question.code}
          </code>
        </pre>
      )}
      <div className="flex flex-col gap-3 mb-6" data-oid="_twb15o">
