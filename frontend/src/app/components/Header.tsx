...
export default function Header() {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 w-full z-[100] backdrop-blur-[10px] py-3 bg-black/5 dark:bg-white/6 border-b border-black/[0.08] dark:border-white/[0.145]">
      <div className="w-full px-4 flex items-center justify-center relative xl:px-5 md:items-stretch md:gap-3 sm:gap-3">
