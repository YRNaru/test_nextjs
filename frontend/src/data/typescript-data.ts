...
export const primitiveTypesData: LearningSection = {
  ...
  title: "プリミティブ型",
  description:
    "TypeScriptでは、JavaScriptで一般的に使用されるプリミティブ型に対応した型が用意されています。",
  keyPoints: [
    "string（文字列）",
    "number（数値）",
    "boolean（真偽値）",
...
export const anyTypesData: LearningSection = {
  ...
  title: "any型",
  description:
    "any型はTypeScriptの型チェックを無効化する特別な型です。JavaScriptからTypeScriptへの移行時以外は、原則として使用を避けるべきです。",
  keyPoints: [
    "any型はどんな型の値でも代入可能",
    "型チェックを一切行わない",
  ...
  examples: [
    {
      ...
      explanation:
        "any型を使った瞬間、その値はなんでもできるオブジェクトになります。これはまさに「JavaScriptと同じ動作」に戻ってしまうということです。",
    ...
    },
    {
      ...
      explanation:
        "unknown型はany型と似ていますが、使う前に型チェックを要求します。any型は「なんでも通す」ので安全性が著しく下がります。",
      keyPoints: [
        "unknown型は型チェックを要求",
        "any型は型チェックを無効化",
        "極力unknown型を検討すべき",
...
export const arrayTypesData: LearningSection = {
  ...
  title: "配列型",
  description:
    "TypeScriptでは、配列に含まれる要素の型を明示的に指定することができます。これにより、配列の要素に異なる型の値が入らないように静的にチェックできます。",
  keyPoints: [
    "string[] - 文字列だけの配列",
  ...
  examples: [
    ...
    },
    {
      ...
      explanation:
        "string[]とArray<string>は意味は同じですが、ジェネリクスに慣れている人には後者が読みやすい",
    ...
    },
    {
      ...
      explanation:
        "配列の各要素に順序通りの型を指定したいときに使います。「1番目はstring」「2番目はnumber」というような明確な型定義が可能です",
...
export const objectTypesData: LearningSection = {
  ...
  title: "オブジェクト型",
  description:
    "TypeScriptでは、オブジェクトの構造（プロパティ名と型）を明確に定義することで、意図しないプロパティの追加や誤った型の代入を防げます。",
  keyPoints: [
  ...
  examples: [
    ...
    },
    {
      ...
      incorrectUsage:
        "type User = { name: string; age: number }\nconst user: User = { name: 'Takuya', age: '36' }",
      explanation:
        "オブジェクト型は記述が長くなりがちなので、型エイリアスと組み合わせて使われることが多いです",
...
export const functionTypesData: LearningSection = {
  ...
  title: "関数型",
  description:
    "TypeScriptでは、関数の引数や戻り値に対して型を指定することで、予期しない呼び出しミスやバグを防ぐことができます。",
  keyPoints: [
  ...
  examples: [
    {
      ...
      incorrectUsage:
        "function sayHello(name: string): string {\n  return `Hello ${name}`;\n}\nsayHello(100);  // ❌ エラー",
      explanation:
        "引数と戻り値に型を指定することで、型安全性が保たれます。間違った型の値を渡すとコンパイルエラーになります。",
    ...
    },
    {
      ...
      explanation:
        "オプショナル引数は省略可能ですが、関数内で使用する際はundefinedの可能性を考慮する必要があります。Null合体演算子（??）などを使用して安全に処理しましょう。",
    ...
    },
    {
      ...
      incorrectUsage:
        'function sayHello(name: string, greeting: string = "Hello"): string {\n  return `${greeting} ${name}`;\n}\nsayHello();  // ❌ 必須引数が不足',
      explanation:
        "デフォルト引数は、引数が省略された場合に自動的にデフォルト値が使用されます。オプショナル引数と異なり、undefinedの可能性はありません。",
    ...
    },
    {
      ...
      incorrectUsage:
        'function printName(firstName: string, formatter: any) {\n  console.log(formatter(firstName));\n}\n\nprintName("Takuya", "not a function");  // ❌ 実行時エラー',
      explanation:
        "関数の型を指定することで、正しい関数が渡されることを保証できます。any型を使うと型安全性が失われ、実行時エラーの原因になります。",
    ...
    },
    {
      ...
      correctUsage:
        "const sayHello = (name: string): string => `Hello ${name}`;\nconst add = (a: number, b: number): number => a + b;",
      incorrectUsage:
        "const sayHello = (name: string) => `Hello ${name}`;  // 戻り値の型が推論される\nconst add = (a, b) => a + b;  // 引数の型が不明",
      explanation:
        "アロー関数でも通常の関数と同じように型を明示できます。型を省略すると型推論が働きますが、明示的に指定することで意図を明確にできます。",
...
export const inferenceTypesData: LearningSection = {
  ...
  title: "型推論",
  description:
    "TypeScriptには型推論（type inference）という機能があり、変数を初期化するときに代入された値から自動的に型を決定してくれます。",
  keyPoints: [
  ...
  examples: [
    {
      ...
      incorrectUsage:
        "const age = 10;\nconsole.log(age.length); // ❌ エラー: number型にはlengthプロパティがない",
      explanation:
        "ageは数値で初期化されているため、number型として推論されます。number型にはlengthプロパティがないため、コンパイルエラーになります。",
      keyPoints: [
        "初期化時の値から型を推論",
        "推論された型に基づくチェック",
        "コンパイル時のエラー検出",
    ...
    },
    {
      ...
      explanation:
        "オブジェクトの各プロパティも初期化時の値から型が推論されます。nameはstring型、ageはnumber型として推論され、それぞれの型に基づいてチェックが行われます。",
    ...
    },
    {
      ...
      incorrectUsage:
        'function getUser() {\n  return {\n    name: "Takuya",\n    age: 36\n  };\n}\nconst user = getUser();\nuser.age = "36"; // ❌ エラー: number型に文字列を代入',
      explanation:
        "関数の戻り値も推論されるため、戻り値に対する型チェックも行われます。getUser関数の戻り値は{ name: string; age: number }型として推論されます。",
    ...
    },
    {
      ...
      explanation:
        "namesは文字列の配列で初期化されているため、string[]型として推論されます。メソッド名の綴り間違いもコンパイル時に検出可能です。",
    ...
    },
    {
      ...
      explanation:
        "TypeScriptは変数に代入される値の型もチェックします。標準オブジェクト（window.confirmなど）の返り値の型が一致しないとエラーになります。",
...
export const unknownTypePractice: PracticeQuestion[] = [
  ...
  },
  {
    ...
    options: ["typeofで型を判定する", "そのまま使う", "any型にする", "エラーになるまで試す"],
    correctAnswer: 0,
...
export const neverTypePractice = [
  {
    ...
    correctAnswer: 0,
    explanation:
      "never型は決して値を返さない（例外を投げる、無限ループなど）関数の戻り値型として使われます。",
  },
  {
    question: "switch文のdefaultでnever型を使うメリットは？",
    options: ["コードが短くなる", "分岐漏れをコンパイル時に検出できる", "実行速度が速くなる"],
    correctAnswer: 1,
    explanation:
      "defaultでnever型を使うことで、enumに新しい値が追加された際に分岐漏れを検出できます。",
  },
  {
    question: "次のうち、never型の関数の特徴として正しいものはどれ？",
    options: ["必ず値を返す", "例外を投げるか無限ループする", "どんな値でも返せる"],
    correctAnswer: 1,
...
export const asyncAwaitPractice = [
  {
    ...
    options: ["number", "Promise<number>", "void", "string"],
    correctAnswer: 1,
  ...
  },
  {
    ...
    options: ["try...catchを使う", "catchしない", "Promise.allで処理する", "thenだけ使う"],
    correctAnswer: 0,
...
export const typeDefinitionPractice = [
  ...
  },
  {
    ...
    code: "",
    options: ["react", "@types/react", "jquery", "@types/jquery"],
    correctAnswer: 0,
...
export const sectionPracticeQuestions = {
  variables: [
    {
      ...
      code: "let a = 10;",
      options: ["関数スコープ", "ブロックスコープ", "再代入不可", "型注釈不可"],
      correctAnswer: 1,
    ...
    },
    {
      ...
      code: "const num = 100;",
      options: ["再代入可能", "ブロックスコープ", "関数スコープ", "型注釈不可"],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: ["ブロックスコープ", "再代入不可", "関数スコープ", "型注釈不可"],
      correctAnswer: 2,
  ...
  primitives: [
    ...
    },
    {
      ...
      options: ['color = "赤";', "color = 200;", 'color = "緑";', 'color = "blue";'],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: ['isActive = "true";', "isActive = 1;", "isActive = true;", 'isActive = "yes";'],
      correctAnswer: 2,
  ...
  arrays: [
    ...
    },
    {
      ...
      options: ["numbers.push(4);", 'numbers.push("5");', "numbers.push(6);", "numbers.push(7);"],
      correctAnswer: 1,
  ...
  inference: [
    {
      ...
      code: "let x = 10;",
      options: ["xはany型になる", "xはstring型になる", "xはnumber型になる", "xはboolean型になる"],
      correctAnswer: 2,
  ...
  generic: [
    ...
    },
    {
      ...
      options: ["queue.push(123);", "queue.push(0);", 'queue.push("abc");', "queue.push(999);"],
      correctAnswer: 2,
    ...
    },
    {
      id: "qg3",
      question:
        "Reactのコンポーネントでpropsの型を柔軟に指定したい場合、どのように書くべきですか？",
      code: "",
      options: [
  ...
  unionintersection: [
    ...
    },
    {
      ...
      options: ["id = 123;", 'id = "abc";', "id = true;", 'id = "456";'],
      correctAnswer: 2,
...
console.log(obj.a?.b); // ?`,
      options: ["aが存在しない場合", "bが存在しない場合", "aもbも存在する場合", "常にundefined"],
      correctAnswer: 0,
...
console.log(user.contact?.email);`,
      options: ["null", "undefined", "エラーになる", "空文字"],
      correctAnswer: 1,
  ...
  "non-null-assertion": [
    {
      ...
      correctAnswer: 1,
      explanation:
        "Non-null Assertion Operatorは「この値はnull/undefinedではない」とTypeScriptに伝えるためのものです。",
      type: "non-null",
    },
    {
      id: "non-null-q2",
      ...
      options: ["undefined", "null", "エラーになる", "何も表示されない"],
      correctAnswer: 2,
    ...
    },
    {
      ...
      options: ["0.00と表示される", "undefinedと表示される", "エラーになる", "3.00と表示される"],
      correctAnswer: 2,
...
console.log(user.profile?.name ?? 'NoName');`,
      options: ["undefined", "NoName", "エラーになる", "profile"],
      correctAnswer: 1,
  ...
  "type-guard": [
    ...
    },
    {
      ...
      options: ["'foo' in obj", "'bar' in obj", "typeof obj === 'A'", "obj instanceof A"],
      correctAnswer: 0,
  ...
  "keyof-operator": [
    {
      ...
      options: ["'name' | 'age' | 'email'", "string", "number", "User"],
      correctAnswer: 0,
  ...
  "index-signature": [
    ...
    },
    {
      ...
      options: ["エラーになる", "許可される", "値がany型になる", "numberキーに変換される"],
      correctAnswer: 0,
  ...
  readonly: [
    ...
    },
    {
      ...
      options: ["再代入できない", "参照できない", "型がanyになる", "プロパティ名が変更される"],
      correctAnswer: 0,
...
export const assertionTypesData: LearningSection = {
  ...
  title: "型アサーション",
  description:
    "TypeScriptでは、ある値の型を開発者が「この型だと確信している」と明示するために型アサーション（Type Assertion）を使います。",
  keyPoints: [
  ...
  examples: [
    ...
    },
    {
      ...
      incorrectUsage:
        'const input = document.getElementById("myInput") as HTMLDivElement; // 実際はInput要素',
      explanation:
        "TypeScriptが型を特定できない場合、開発者が正しい型を指定することで型安全に操作できます。",
    ...
    },
    {
      ...
      explanation:
        "型が大きく異なる場合、一度unknownやanyを経由してアサーションするテクニックです。",
    ...
    },
    {
      ...
      explanation:
        "型アサーションはTypeScriptの型チェックを回避するため、誤った型を指定すると実行時エラーになります。",
...
export const aliasTypesData: LearningSection = {
  ...
  examples: [
    ...
    },
    {
      ...
      explanation:
        "ジェネリック型エイリアスで、さまざまな型に対応した再利用可能な型を定義できます。",
...
export const variableTypesData: LearningSection = {
  ...
  title: "変数",
  description:
    "TypeScriptの変数宣言はJavaScriptと同じルールですが、型注釈（Type Annotation）を付けられる点が特徴です。",
  keyPoints: [
...
export const interfaceTypesData = {
  ...
  title: "インタフェース",
  description:
    "TypeScriptのインタフェースは、オブジェクト型の構造やクラスの契約を定義するための機能です。型エイリアスより拡張性が高く、クラスとの連携で特に有用です。",
  keyPoints: [
  ...
  examples: [
    ...
    },
    {
      ...
      example:
        'interface IUser { name: string; age: number; sayHello: () => string; }\nclass User implements IUser {\n  name = "";\n  age = 0;\n  sayHello() { return `こんにちは、私は${this.name}、${this.age}歳です。`; }\n}',
...
export const classTypesData: LearningSection = {
  ...
  title: "クラス",
  description:
    "TypeScriptでは、ES2015（ES6）で導入されたJavaScriptのクラス構文に型付けを加えて利用できます。クラスの定義、継承、インタフェースの実装、アクセス修飾子など、オブジェクト指向の機能を型安全に扱えます。",
  keyPoints: [
    "class キーワードでクラスを定義",
    "フィールドやメソッドに型を明示",
    "constructorで初期化処理",
  ...
  examples: [
    ...
    },
    {
      ...
      explanation:
        "extendsで親クラスを継承し、super()で親のconstructorを呼び出します。親クラスのメソッドも利用可能です。",
    ...
    },
    {
      ...
      explanation:
        "publicはどこからでも、privateはクラス内のみ、protectedはサブクラスからもアクセス可能です。",
    ...
    },
    {
      ...
      explanation:
        "クラス定義、フィールド・メソッドの型、継承、implements、アクセス修飾子など、TypeScriptのクラスは型安全なオブジェクト指向設計を実現します。",
      keyPoints: [
        "class キーワードで定義",
        "フィールド・メソッドの型明示",
        "継承（extends）",
...
export const enumTypesData: LearningSection = {
  ...
  title: "Enum型",
  description:
    "TypeScript独自のEnum（列挙型）は、名前付き定数のセットを型安全に管理できる便利な機能です。数値・文字列EnumやUnion型との比較も理解しましょう。",
  keyPoints: [
    "enumで名前付き定数セットを定義",
    "デフォルトは0からの連番（数値Enum）",
    "文字列Enumも定義可能",
  ...
  examples: [
    ...
    },
    {
      ...
      explanation:
        "Enumは型安全な定数セットを簡潔に定義でき、数値・文字列EnumやUnion型との使い分けも重要です。",
      keyPoints: [
        "enumで定数セットを型安全に管理",
        "数値Enum・文字列Enumの使い分け",
        "Union型との違いも理解",
...
export const genericTypesData: LearningSection = {
  ...
  title: "ジェネリック型",
  description:
    "ジェネリック（Generics）は、クラスや関数の中で使う型を外部から指定できる仕組みです。型安全性を保ちながら柔軟なコードを実現します。",
  keyPoints: [
    "型パラメータ（Tなど）で型を抽象化",
    "利用時に具体的な型を指定",
    "型安全性と柔軟性を両立",
  ...
  examples: [
    ...
    },
    {
      ...
      explanation:
        "ジェネリック型は型安全性と柔軟性を両立し、配列・キュー・Reactなどで広く使われます。",
      keyPoints: ["型パラメータで型を抽象化", "利用時に型を指定", "型安全性と柔軟性の両立"],
...
export const unionIntersectionTypesData: LearningSection = {
  ...
  description:
    "Union型（|）は「いずれかの型」、Intersection型（&）は「すべての型」を満たす型を定義できます。型エイリアスや複合型設計で活用されます。",
  keyPoints: [
    "Union型（|）は「AまたはB」",
  ...
  examples: [
    ...
    },
    {
      ...
      example:
        "type Identity = { id: number | string; name: string; }\ntype Contact = { name: string; email: string; phone: string; }\ntype IdentityOrContact = Identity | Contact;",
    ...
    },
    {
      ...
      correctUsage:
        'const employee: Employee = { id: "111", name: "Takuya", email: "test@example.com", phone: "012345678" };',
      incorrectUsage:
        'const employee: Employee = { name: "Takuya", email: "test@example.com", phone: "012345678" }; // idが不足',
    ...
    },
    {
      ...
      explanation:
        "Union型は「AまたはB」、Intersection型は「AかつB」。用途に応じて使い分けましょう。",
      keyPoints: ["Union型は柔軟性", "Intersection型は合成", "型エイリアスで複雑な型も定義可能"],
...
export const literalTypesData: LearningSection = {
  ...
  title: "リテラル型",
  description:
    "リテラル型は、特定の値のみを許可する型です。文字列や数値など、決まった値だけを型として指定できます。",
  keyPoints: [
    "特定の値のみ許可する型",
    "|（パイプ）で複数の値を区切る",
    "間違った値はコンパイル時にエラー",
  ...
  examples: [
    ...
    },
    {
      ...
      keyPoints: ["特定の値のみ許可", "間違った値はエラー", "状態管理やAPIレスポンスで活用"],
  ...
  examples: [
    {
      title: "常に例外を投げる関数",
      description:
        "この関数は決して正常終了して値を返すことがないため、戻り値型を never と定義します。",
    ...
    },
    {
      title: "型チェック網羅性保証",
      description:
        "TypeScriptに「ここは到達しないコードである」ことを伝えられます。将来型が追加された場合、分岐漏れをコンパイルエラーで検知可能です。",
    ...
    },
    {
      title: "switch文での使用",
      description:
        "default で never を使うと、enumに新しい値が追加された際にswitch文の漏れを検出できます。",
...
export const optionalChainingData = {
  ...
  description:
    "Optional Chaining（オプショナルチェイニング）は、ネストされたオブジェクトプロパティへのアクセス時に、途中のプロパティがnullやundefinedであっても実行時エラーにならず、undefinedを返す構文です。TypeScript 3.7から導入されました。",
  keyPoints: [
  ...
  examples: [
    {
      ...
      explanation:
        "?. を使うことで、途中のプロパティがundefinedやnullでもエラーにならずundefinedを返します。",
    ...
    },
    {
      ...
      explanation:
        "social?.facebook は social が存在する場合のみ facebook にアクセスし、それ以外の場合は undefined を返します。",
...
export const nonNullAssertionData = {
  ...
  description:
    "Non-null Assertion Operator（!）は、「この値は絶対にnull/undefinedではない」とTypeScriptに伝えるための演算子です。nullやundefinedの可能性がある変数・プロパティに対して、型エラーを回避できますが、実行時にはnullチェックが行われないため注意が必要です。",
  keyPoints: [
  ...
  examples: [
    {
      ...
      explanation:
        "name! と書くことで「ここではnameはnull/undefinedではない」とTypeScriptに伝えられます。ただし、実行時にはnullチェックが行われないため、存在しない場合は例外が発生します。",
...
export const nullishCoalescingData = {
  ...
  description:
    "Nullish Coalescing Operator（??）は、左辺がnullまたはundefinedの場合に右辺の値を返す演算子です。null/undefined時のデフォルト値設定に便利で、0や空文字はそのまま扱われます。",
  keyPoints: [
...
export const typeGuardData = {
  ...
  description:
    "型ガード（Type Guard）は、TypeScriptで変数の型を特定の型に絞り込むテクニックです。typeofやinstanceof、in演算子、カスタム関数などで型を判別し、安全に処理を記述できます。",
  keyPoints: [
...
export const keyofOperatorData = {
  ...
  title: "keyofオペレーター",
  description:
    "keyofオペレーターは、指定した型のプロパティ名をUnion型として返す演算子です。型安全にオブジェクトのキーを扱う際や、ジェネリック関数・Mapped Typesでよく使われます。",
  keyPoints: [
...
export const indexSignatureData = {
  ...
  description:
    "インデックス型（Index signature）は、オブジェクトのプロパティ名が固定されない場合に、キーと値の型をまとめて定義できるTypeScriptの機能です。APIレスポンスや可変設定など、動的なキーを持つオブジェクトに便利です。",
  keyPoints: [
  ...
  examples: [
    ...
    },
    {
      ...
      explanation:
        "numberキーも内部的にはstringとして扱われますが、stringキー型にはnumberキーは代入できません。",
...
export const unknownTypeData = {
  ...
  title: "unknown型",
  description:
    "unknown型は「型が不明であることを明示的に示すための型」です。TypeScript 3.0から導入され、any型よりも安全に「何でも受け取れる」用途で使われます。",
  keyPoints: [
  ...
  examples: [
    {
      ...
      explanation:
        "unknown型はany型と同様にどんな値でも代入できますが、型チェックなしでプロパティやメソッドにアクセスするとエラーになります。",
    ...
    },
    {
      ...
      explanation:
        "any型は型チェックを無効化するため危険ですが、unknown型は型チェックを強制するため安全です。",
    ...
    },
    {
      ...
      incorrectUsage: "y.toFixed(1); // 型チェックなしはエラー",
      explanation:
        "型アサーションを使うことで、unknown型の値を特定の型として扱うことができます。ただし、型の保証は自己責任です。",
...
export const asyncAwaitData = {
  ...
  description:
    "async/awaitはPromiseベースの非同期処理を直感的・同期的に記述できる構文です。TypeScriptでも利用でき、戻り値の型も明確にできます。",
  keyPoints: [
  ...
  examples: [
    {
      ...
      incorrectUsage:
        'function asyncFunc() {\n  const result = await fetchFromServer("111");\n  return `The result: ${result.success}`;\n}',
      explanation:
        "async functionでなければawaitは使えません。async functionは常にPromiseを返します。",
    ...
    },
    {
      ...
      explanation:
        "async/awaitのエラーはtry...catchで捕捉できます。catchしないと未処理例外になります。",
    ...
    },
    {
      ...
      correctUsage:
        'const [a, b] = await Promise.all([fetchFromServer("1"), fetchFromServer("2")]);',
      incorrectUsage:
        'const a = await fetchFromServer("1");\nconst b = await fetchFromServer("2"); // 直列で遅い',
...
export const typeDefinitionData = {
  ...
  title: "型定義ファイル（.d.ts）",
  description:
    "型定義ファイル（.d.ts）は、JavaScriptライブラリをTypeScriptで型安全に使うための橋渡しとなるファイルです。@types経由での導入や自作も可能です。",
  keyPoints: [
